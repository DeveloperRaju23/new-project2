...
import image1 from "../../public/FreshlyMadeEver.png"
const FreshlyMode = () => {
  return (
    <div className='flex flex-col justify-center hero_section'>
    <div className='mx-auto'>
    <Image className="rounded-lg mx-auto" src={logo} alt={logo}></Image>
     <h2 className='text-[24px] text-primaryClr font-serifFont font-semibold text-center'>Freshly Made Every Day</h2>
